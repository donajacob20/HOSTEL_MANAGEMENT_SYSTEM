...
public class StudentData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(806, 574));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"200749", "Ashwin", "CSE", "R5A", "Annex 3", "A", "109", "ABC,DEF,GHI", "6", "15000"},
            ...
            new String [] {
                "Adm No", "Name", "Branch", "Class", "Hostel", "Block No", "Room No", "Roommates", "Pending Months", "Total Fees"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Block A", "Block B", "Block C" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Annex 1", "Annex 2 ", "Golden Jubilee" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "CSE", "Mechanical", "Civil", "Chemical" }));
